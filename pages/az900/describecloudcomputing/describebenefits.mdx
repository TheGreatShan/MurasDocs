...
## Management in cloud
There are multiple tools to manage in the cloud
Here I will list the possibilities in Azure:
1. Azure portal (Web)
2. Azure CLI (Command line)
3. Azure PowerShell (Command line)
4. Azure Cloud Shell (Command line)
5. Using Azure API (API)